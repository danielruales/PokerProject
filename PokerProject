...
public:
    ...
    PrettyCards(string prettyface, string prettyrank);
    
    string pretty_face(string prettyface);
    
    bool pretty_rank(string prettyrank);
...
public:
    ...
    PrettyArray(string a, string b, string c) {
    ...
    PrettyArray(string a, string b, string c, string d, string e) {
